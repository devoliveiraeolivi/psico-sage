...
export const mockSessoes: Sessao[] = [
  {
    ...
    paciente_id: '1',
    numero_sessao: 33,
    data_hora: '2024-10-28T09:00:00Z',
    duracao_prevista: 50,
    duracao_real: 48,
    status: 'aguardando_aprovacao',
    calendar_event_id: 'cal-789',
    fathom_call_id: 'fathom-790',
    preparacao: {
      contexto: 'Continuação do trabalho de manutenção.',
      pontos_retomar: ['Progresso no diário', 'Reunião com chefe'],
      tarefas_pendentes: [],
      sugestoes: [],
      perguntas_sugeridas: [],
      alertas: [],
    ...
    resumo: {
      sintese: 'Sessão focada em revisão de ganhos. Paciente demonstrou boa capacidade de autoregulação.',
      humor: 'positivo',
      temas: ['autoeficácia', 'progresso terapêutico'],
      insights: ['Reconheceu que evita menos situações sociais'],
      pontos_importantes: ['Mantém diário regularmente', 'Usou técnica em 3 situações'],
      tarefas: ['Expandir exposições graduais'],
      alertas: [],
    },
    integra: '[Transcrição pendente de revisão]',
    deleted_at: null,
  ...
  },
  {
    ...
    paciente_id: '2',
    numero_sessao: 15,
    data_hora: '2024-10-27T14:00:00Z',
    duracao_prevista: 50,
    duracao_real: 52,
    status: 'aguardando_aprovacao',
    calendar_event_id: 'cal-791',
    fathom_call_id: 'fathom-792',
    preparacao: {
      contexto: 'Processo de luto em andamento.',
      pontos_retomar: ['Carta para o pai'],
      tarefas_pendentes: [],
      sugestoes: [],
      perguntas_sugeridas: [],
      alertas: [],
    ...
    resumo: {
      sintese: 'Paciente conseguiu finalizar carta para o pai. Sessão emocionalmente intensa mas produtiva.',
      humor: 'emocionado mas aliviado',
      temas: ['luto', 'despedida simbólica', 'aceitação'],
      insights: ['Percebeu que guardar sentimentos não ajuda no processo'],
      pontos_importantes: ['Leu carta em voz alta', 'Primeiro choro genuíno sobre perda'],
      tarefas: ['Ritual de despedida no aniversário'],
      alertas: ['Acompanhar semana do aniversário'],
    },
    integra: '[Transcrição pendente de revisão]',
    deleted_at: null,
