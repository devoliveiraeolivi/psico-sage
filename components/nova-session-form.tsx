    ...
    <div className="grid gap-6 lg:grid-cols-[280px_1fr]">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4 space-y-4">
          ...
          <div>
            ...
            <select
              id="paciente"
              value={pacienteId}
              onChange={(e) => { setPacienteId(e.target.value); setShowExtraForm(false) }}
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  ...
                  {showExtraForm ? 'Cancelar' : 'Sessão extra'}
                </button>
              </div>
            </div>
          )}

          {/* Formulário de criação manual — aparece se não tem recorrência OU se pediu sessão extra */}
          {(!hasRecurrence || showExtraForm) && (
              ...
              >
                {submitting ? (
                  ...
                  <>
                    ...
                    {showExtraForm ? 'Agendar Sessão Extra' : 'Agendar Sessão'}
                  </>
                )}
              </button>
            </form>
      ...
      <div>
        <UnifiedCalendar
          sessions={sessions}
          views={['semana']}
          selectedDate={hasRecurrence && !showExtraForm ? undefined : dataHora}
